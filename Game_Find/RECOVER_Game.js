...
lib.ssMetadata = [
		{name:"RECOVER_Game_atlas_1", frames: [[0,722,915,230],[0,0,1280,720]]}
];
...
(lib.CachedBmp_1 = function() {
	this.initialize(ss["RECOVER_Game_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.RECOVER_Game = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1.setTransform(0,1,0.4295,0.5318);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_Game_atlas_1.png?1707645521393", id:"RECOVER_Game_atlas_1"}
	],
	preloads: []
};
