...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.isda1},{t:this.isda2},{t:this.isda3}]}).wait(1));

	// Bubbles
	this.b19 = new lib.Bubbles("synched",0);
	this.b19.name = "b19";
	this.b19.setTransform(495.7,132.1,1,1,0,0,0,5.5,5.5);

	this.b18 = new lib.Bubbles("synched",0);
	this.b18.name = "b18";
	this.b18.setTransform(442.55,178.6,1,1,0,0,0,5.5,5.5);

	this.b17 = new lib.Bubbles("synched",0);
	this.b17.name = "b17";
	this.b17.setTransform(356.3,253.85,1,1,0,0,0,5.5,5.5);

	this.b20 = new lib.Bubbles("synched",0);
	this.b20.name = "b20";
	this.b20.setTransform(339.5,139,1,1,0,0,0,5.5,5.5);

	this.b16 = new lib.Bubbles("synched",0);
	this.b16.name = "b16";
	this.b16.setTransform(254.5,192.2,1,1,0,0,0,5.5,5.5);

	this.b15 = new lib.Bubbles("synched",0);
	this.b15.name = "b15";
	this.b15.setTransform(186.75,178.6,1,1,0,0,0,5.5,5.5);

	this.b14 = new lib.Bubbles("synched",0);
	this.b14.name = "b14";
	this.b14.setTransform(91.9,218.2,1,1,0,0,0,5.5,5.5);
	...
	this.b10.name = "b10";
	this.b10.setTransform(126.4,96,1,1,0,0,0,5.5,5.5);
	...
	this.b12.name = "b12";
	this.b12.setTransform(130.4,289.7,1,1,0,0,0,5.5,5.5);

	this.b11 = new lib.Bubbles("synched",0);
	this.b11.name = "b11";
	this.b11.setTransform(199.55,314.7,1,1,0,0,0,5.5,5.5);

	this.b9 = new lib.Bubbles("synched",0);
	this.b9.name = "b9";
	this.b9.setTransform(328.5,314.7,1,1,0,0,0,5.5,5.5);

	this.b7 = new lib.Bubbles("synched",0);
	this.b7.name = "b7";
	this.b7.setTransform(409.6,300.7,1,1,0,0,0,5.5,5.5);
	...
	this.b5.name = "b5";
	this.b5.setTransform(434.9,350.2,1,1,0,0,0,5.5,5.5);

	this.b4 = new lib.Bubbles("synched",0);
	this.b4.name = "b4";
	this.b4.setTransform(356.3,363.55,1,1,0,0,0,5.5,5.5);
	...
	this.b2.name = "b2";
	this.b2.setTransform(148,363.55,1,1,0,0,0,5.5,5.5);

	this.instance = new lib.Bubbles("synched",0);
	this.instance.setTransform(99.05,357.2,1,1,0,0,0,5.5,5.5);
	...
	// Bg
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#32609D").s().p("EgyTAMVQzPpuhdtbQEuIuNlG2QU0KidcAAQdbAAU0qiQU0qfAAu4QAAhJgIhGQChEpAAFLQAAMuvOJhQilBnjBBhQ00Ki9bAAQ9cAA00qig");
	this.shape_1.setTransform(397.7875,165.25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#32365C").s().p("EgupAOmQ00qhAAu3QAAnwFpmkIAAAdQAAFLChEpQBdNcTPJtQU0KidbAAQdcAAU0qiQDBhhClhnQlDFEolEWQ00Kh9cAAQ9bAA00qhg");
	this.shape_2.setTransform(322.9875,190.975);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#32B4F4").s().p("EgyPAZZQtlm3kuovQihkoAAlLIAAgdQAVukUfqXQU0qidbAAQdcAAU0KiQTPJuBdNdQAIBGAABHQAAO400KhQ00Kh9cABQ9bgB00qhg");
	this.shape_3.setTransform(382.1,33.2);
...
p.nominalBounds = new cjs.Rectangle(166.2,3.3,738.2,386.8);
// library properties:
lib.properties = {
