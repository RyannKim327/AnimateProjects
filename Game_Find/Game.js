...
if (reversed == null) { reversed = false; }
	...
	this.mgaisda3.setTransform(845.8,332.4,1,1,0,0,0,56.2,36.9);

	this.mgaisda2 = new lib.mgaisda();
	this.mgaisda2.name = "mgaisda2";
	this.mgaisda2.setTransform(620.1,246.5,1,1,0,0,0,56.2,36.9);

	this.mgaisda1 = new lib.mgaisda();
	this.mgaisda1.name = "mgaisda1";
	this.mgaisda1.setTransform(814.7,157.7,1,1,0,0,0,56.2,36.9);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Game_atlas_1.png?1707700828605", id:"Game_atlas_1"}
	],
	preloads: []
};
